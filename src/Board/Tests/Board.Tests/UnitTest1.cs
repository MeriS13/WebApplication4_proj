...
// Тут будут все тесты по сервису категорий
public class CategoryServiceTests 
{
    ...
    public async Task Category_GetById_Success(List<Category> List)
    {
        ...
        // expected - переменная для поиска категории по идентификатору, сгенеренному выше
    ...
    public async Task Category_Create_Success(List<Category> List)
    {
        ...
        // Созд дто для передачи его в метод сервиса
        CreateCategoryDto dto = new CreateCategoryDto()
        {
            Name = name,
        };
        // Созд домен.модель для передачи ее в метод репозитория
